...
SECRET_KEY = 'k#(o!jrw^hlxj&+ecgkh5p8aw%cndxf^*!(3pkbq5_7)sjcu$f'
...
INSTALLED_APPS = [
    ...
    'django_extensions',
    'imagekit', # pip intall Pillow pilkit django-imagekit
]
...
# Static File의 URL을 만들 때 사용 하는 값
STATIC_URL = '/static/' # Prodution 단계에서 사용하는 옵션
